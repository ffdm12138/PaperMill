...
# Writes legacy fields metadata schema_version 1.1, title.short_zh, title.translated_zh,
# and reads content_identity.content_title. Do not run against the active library.
