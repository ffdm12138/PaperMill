"""Read-only audit engines for the discovery reset-state diagnostics.
...
``scripts/audit_discovery_reset_state.py`` is the argparse wiring around
:func:`audit_reset_state`.
"""
...
def audit_reset_state(*, data_root: Path | None = None, expected_formal_count: int = 4) -> dict[str, Any]:
    """Run every component audit engine read-only and derive readiness."""
