...
Metadata is read-only citation truth. Catalog is the full content-understanding archive and the source of `content_title_zh`/`paper_name`. Formalize only writes an installation plan; commit performs final renaming in hidden staging.
