...
> **Historical audit record; not current SOP.** See
> [`docs/PROJECT_STATUS.md`](../PROJECT_STATUS.md) and
> [`docs/PROJECT_CONTRACT.md`](../PROJECT_CONTRACT.md) for current schema
> and state. Catalog/metadata version references in this file are frozen
> historical facts and do not represent current active state.
